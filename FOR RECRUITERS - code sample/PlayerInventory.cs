...
/*
    Communication between player inventory and the UI part of the inventory uses events
*/
...
public class PlayerInventory : MonoBehaviour
{
    ...
    public void Awake()
    {
        ...
        for (int slotNumber = 0; slotNumber < inventorySlotCount; slotNumber++)
        {
            ...
            inventoryItems[slotNumber].GetComponent<InventoryItemSlotScript>().OnItemDrop += RemoveItemFromInventory;
            inventoryItems[slotNumber].GetComponent<InventoryItemSlotScript>().slotNumber = slotNumber;
        }
    }
